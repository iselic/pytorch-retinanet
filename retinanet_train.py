...
def infer(val_csv,classes_csv,model_fname,resnet_depth,out_dir, results_fname):

    dataset_val = CSVDataset(train_file=val_csv, class_list=classes_csv,transform=transforms.Compose([Normalizer(), Resizer()]))
